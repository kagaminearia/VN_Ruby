...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/FZCQJW.TTF"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/FZCQJW.TTF"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/FZCQJW.TTF"
...
define gui.name_yalign = 0.4

## 包含角色名字的方框的宽度、高度和边框尺寸，或设为 None 来自动确定其大小。
define gui.namebox_width = 221
